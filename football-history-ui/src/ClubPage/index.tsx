...
import { HistoricalPositionsGraph } from "../components/HistoricalPositions/Graph";
import { AppSubPage } from "../App";
import { LeagueTable } from "../components/LeagueTable/Table";
import { SeasonFilter } from "../components/Filters/SeasonFilter";
import { Matches } from "../components/ClubMatches/Matches";
...
const ClubPage: FunctionComponent<{
    ...
    if (activeSubPage === "Positions") {
        body = selectedClub && (
            <HistoricalPositionsGraph selectedClub={selectedClub} seasons={seasons} />
        );
        ...
        body = selectedClub && (
            <>
                ...
                />
                {selectedSeason && (
                    <Matches selectedSeason={selectedSeason} selectedClub={selectedClub} />
                )}
            </>
        );
    }
