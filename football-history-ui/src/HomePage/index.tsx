  ...
  return (
    <div
      style={{
        ...
        gridTemplateAreas: "topGutter, body",
      }}
    >
      <div style={{ gridArea: "body" }}>
        ...
        <p>
          ...
          divisions in the English Football League since the 1992-93 season. Further data will be
          added covering the Football League all the way back to 1888 when it was founded, as well
          as pages dedicated to club and league histories.
        </p>
        ...
        <ul>
          ...
          <li>
            A second tier, the Second Division, was added to the league for the 1892-93 season.
          </li>
        ...
        <ul>
          ...
          <li>
            ...
            Division whilst First Division teams losting the mini-league were offered a place in the
            Second Division.
          </li>
        </ul>
        <ul>
        ...
        <ul>
          ...
          <li>
            From 1988-89 however, the play-offs were made up of 4 teams from the lower division
            only.
          </li>
          <li>
