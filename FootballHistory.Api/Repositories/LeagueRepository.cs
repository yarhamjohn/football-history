...
namespace FootballHistory.Api.Repositories
{
    public class LeagueRepository : ILeagueRepository
    {
        ...
        public LeagueRepository(LeagueSeasonContext context, IPlayOffMatchesRepository playOffMatchesRepository, ILeagueMatchesRepository leagueMatchesRepository)
        {
