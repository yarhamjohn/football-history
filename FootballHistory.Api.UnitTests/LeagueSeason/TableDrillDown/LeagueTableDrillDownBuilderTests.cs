...
namespace FootballHistory.Api.UnitTests.LeagueSeason.TableDrillDown
{
    [TestFixture]
    public class LeagueTableDrillDownBuilderTests
    {
        ...
        public void Setup()
        {
            ...
            leagueTableBuilder
                ...
                .Returns(new Api.LeagueSeason.Table.LeagueTable { Rows = new List<LeagueTableRow> { new LeagueTableRow { Team = "Team1" } } });
