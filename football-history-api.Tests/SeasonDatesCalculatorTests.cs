...
namespace football.history.api.Tests
{
    ...
    public class SeasonDatesCalculatorTests
    {
        ...
        {
            var seasonStartYear =
                SeasonDatesCalculator.GetSeasonStartYear(new DateTime(2019, 08, 01));
        ...
        {
            var seasonStartYear =
                SeasonDatesCalculator.GetSeasonStartYear(new DateTime(2020, 08, 01));
            Assert.That(seasonStartYear, Is.EqualTo(2019));
        }
        ...
        {
            var seasonStartYear =
                SeasonDatesCalculator.GetSeasonStartYear(new DateTime(2020, 08, 21));
        ...
        {
            var seasonStartYear =
                SeasonDatesCalculator.GetSeasonStartYear(new DateTime(2021, 08, 01));
